...
const perguntas = [
    {
        enunciado: "Assim que saiu da escola você se depara com uma nova tcnologia,um chat que consegue responde todas as dúvidas que uma pessoa pode ter, ele tanbém gera imagens e áudios hiper-realistas. Qual o primeiro pensamento? ",
        alternativas: [
            "Isso é assustador!",
            "Isso é maravilhoso!"
        ]
